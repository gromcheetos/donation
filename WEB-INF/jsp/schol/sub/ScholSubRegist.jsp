...
function fn_egov_regist_article(){
	...
	if (!validateSchol(schol)) {	
		...
		if(confirm("<spring:message code="common.regist.msg" />")){	
			schol.action = "<c:url value='/schol/sub/insertArticle.do'/>";
			schol.submit();
		}
	} 
}
...
<div id="wrap">
 <!-- header 시작 -->
	...
	<!-- 타이틀 -->
	<div id="search_field">
	<div id="search_field_loc"><h2><spring:message code="scholspecial.list.subscriptionResist" /></h2></div>
	</div>
	<form:form commandName="schol" name="schol" action="${pageContext.request.contextPath}/schol/sub/insertArticle.do" method="post" onSubmit="fn_egov_regist_article(document.forms[0]); return false;"> 
	...
	<div class="xbuttons" style="padding-top:10px;padding-bottom:10px;">
		<ul>
			...
			<li><a class="s_submit" href="<c:url value='/schol/sub/selectScholSubList.do' />" ><spring:message code="button.list" /></a></li>
		</ul>
		<%-- <input type="submit" class="s_submit" value="<spring:message code="button.create" />" title="<spring:message code="button.create" /> <spring:message code="input.button" />" />
		<span class="btn_s"><a href="<c:url value='/schol/sub/selectScholSubList.do' />?scholSeq=${ScholVO.scholSeq}"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span> --%>
	</div>
<!-- 버튼 끝 -->
