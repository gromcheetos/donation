	...
	<head>
		...
		<script type="text/javascript">
			...
			function fn_egov_select_linkPage(pageNo){
				...
				document.articleForm.action = "<c:url value='/schol/special/selectScholSpecialList.do'/>";
			...
			/* ********************************************************
 			 * 상세회면 처리 함수
 			 ******************************************************** */
			function fn_egov_inquire_articledetail(scholSeq,scholItem,emailId) {
				...
				document.articleForm.emailId.value = emailId;
			  	document.articleForm.action = "<c:url value='/schol/special/selectScholSpecialDetail.do'/>";
			  	document.articleForm.submit();
			}
			...
			function benList(value){
				...
				var values = [];
				$.post(
					"/schol/special/beneficiaryAjax.do",
					{scholSeq : value},
					function(retVal){
						var str  ='';
						str +='		<colgroup>';
		...
		<div id="wrap">
    		...
    		<div id="container">
            	...
            	<div id="content">
                	...
                	<!-- 검색 필드 박스 시작 -->
                	<div id="search_field">
                		<div id="search_field_loc"><h2><strong><spring:message code="scholspecial.list.specialList" /></strong></h2></div>
						<form name="articleForm" action="<c:url value='/schol/special/selectScholSpecialList.do'/>" method="post" onSubmit="fn_list(); return false;">
									...
									<ul id="search_first_ul">
										...
										<li>
											<div class="buttons">
												...
												<span class="btn_b"><a href="<c:url value='/schol/special/insertScholSpecialView.do?scholSeq=${serchVO.scholSeq}' />"  title="<spring:message code="button.create" />"><spring:message code="button.create" /></a></span>
											</div>
										</li>
									</ul>
								</div>
						...
						<table summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />" cellpadding="0" cellspacing="0">
							...
							<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
								...
								<tr>
									...
									<td align="left">
	    								<form name="subForm" method="post" action="<c:url value='/schol/special/selectScholSpecialDetail.do'/>">
	...
	<c:choose>
		...
		<c:otherwise>
									...
									<td>
										...
										<%-- <form name="formDlist" action="" method="post" style= "margin:10px 0 0 0;">
											<input type="button" class="s_submit" value="<spring:message code="scholarship.list.beneficiaryList" />" value="${resultInfo.scholSeq}" onclick="javascript:benList('${resultInfo.scholSeq}');">
											<input type="hidden" name="scholSeq" value="<c:out value='${resultInfo.scholSeq}'/>" >
										</form> --%>
									</td>
								</tr>
...
<c:if test="${fn:length(resultList) == 0}">
					...
					<br/>
					<div class="default_tablestyle">
						<table  id="beneficialy" summary="<spring:message code="scholarship.list.beneficiary" arguments="${pageTitle}" />">
