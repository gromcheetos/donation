 ...
 ******************************************************** */
 function fn_egov_delete_article(scholSeq){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.form.action = "<c:url value='/schol/special/deleteArticle.do'/>";
		document.form.submit();	
	}	
}	

function fn_egov_scholCk_ok(){
			document.form.action = "<c:url value='/schol/special/updateScholCk.do'/>";
		  	document.form.submit();		
	}
...
function fn_egov_scholCk_closed(){
	...
	document.form.action = "<c:url value='/schol/special/closeScholCk.do'/>";
 	document.form.submit();
}
function fn_updateForm(){	
	document.form.action = "<c:url value='/schol/special/updateScholSpecialView.do'/>";
	document.form.submit();          
}
...
<div id="wrap">
 <!-- header 시작 -->
	...
	<!-- 타이틀 -->
	<div id="search_field">
		<div id="search_field_loc"><h2><strong><spring:message code="scholspecial.list.specialDetail" /></strong></h2></div>
   	</div>
	...
	<div class="xbuttons" style="padding-top:10px;padding-bottom:10px;">
		...
		<ul>
			...
			<li><a href="<c:url value='/schol/special/selectScholSpecialList.do' />" class="s_submit"><spring:message code="button.list" /></a></li>
	...
	<!--기부자 리스트 시작-->
		...
		<div>
			...
			<tr>
				...
				<th class="board_th_link"><spring:message code="comCopBbs.articleVO.regist.doner" /></th><!--기부자ID  -->
