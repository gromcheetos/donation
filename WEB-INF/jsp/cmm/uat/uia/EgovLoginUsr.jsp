...
<html>
	...
	<body  onload="fnInit();">
		<noscript class="noScriptTitle"><spring:message code="common.noScriptTitle.msg" text="자바스크립트를 지원하지 않는 브라우저에서는 일부 기능을 사용하실 수 없습니다."/></noscript>    
		<!-- 전체 레이어 시작 -->
		<div id="wrap">
    		<!-- header 시작 -->
